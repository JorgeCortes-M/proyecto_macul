...
In this dataset we have two fields related to salary `r_bruta_mens` and `r_liquida_mens`, the first one is the salary without discounts, related to health and others, the second one is with those discounts. First we will visualize the salary data distribution.
...
sns.displot(contrata_2013_2022_clean, x = "r_bruta_mens", color = "red", kind = "kde")
